 <div class="container-fluid p-4 shadow mx-auto" style="max-width: 1000px">
     ...
     View::make('partials/crumbs')?>
     <h4>Profile !!</h4>
     <div class="row">
         <div class="col-sm-4 col-md-3">
             <img src="http://localhost/smsmvcphp/public/assets/user_female.jpg" class="border border-primary d-block mx-auto rounded-circle " style="width:150px;">
